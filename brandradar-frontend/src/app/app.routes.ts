...
export const routes: Routes = [
  ...
  // ── Auth routes (public) ──
  {
    ...
    children: [
      ...
      },
      {
        path: 'reset-password',
        loadComponent: () =>
          import('./features/identity-access/presentation/pages/reset-password/reset-password').then(m => m.ResetPassword),
      },
      {
        path: '',
        redirectTo: 'login',
    ...
    children: [
      {
        path: 'select',
        loadComponent: () =>
          import('./features/brand-workspace/presentation/pages/workspace-select/workspace-select').then(m => m.WorkspaceSelect),
      },
    ],
  },
  ...
  },
  {
    path: 'dashboard',
    loadComponent: () =>
      import('./features/reputation-monitoring/presentation/pages/dashboard/dashboard').then(m => m.DashboardComponent),
